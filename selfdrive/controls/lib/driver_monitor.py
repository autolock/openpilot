...
_AWARENESS_TIME = 900.  # 9.6 minutes limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 90.  # a first alert is issued 90s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 90.  # a second alert is issued 90s before start decelerating the car
_DISTRACTED_TIME = 11.
...
MAX_TERMINAL_ALERTS = 9 # not allowed to engage after 3 terminal alerts
